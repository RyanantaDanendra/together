    ...
    if (auth.user.as == "admin") {
        return (
            <AdminLayout>
                ...
                <div className="usersDashboard-container w-full flex justify-center gap-3 text-white mt-40">
                    <div>
                        ...
                        <table>
                            <thead>
                                <tr className="border-b-2 border-b-white">
                                    <th className="pe-10 text-2xl text-center font-bold">
                                        Id{" "}
                                    </th>
                                    <th className=" text-2xl font-bold text-center">
                                        Image{" "}
                                    </th>
                                </tr>
                            </thead>
