...
const AdminLayout = ({ children }) => {
    ...
    const showMenu = () => {
        if (window.innerWidth > 1024) {
            return (
                <nav
                    className="h-full w-64 fixed text-white flex justify-center flex-col gap-8 ps-4 z-10"
                ...
                >
                    ...
                    <div className="link flex gap-2">
                        ...
                        <Link
                            className="text-xl"
                            href={route("dashboard.batch19images")}
                        >
                            Batch 19 Images
                        </Link>
                    </div>
                ...
                <>
                    <div className="hamburger-menu" onClick={() => openMenu()}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 640"
                            className="md:w-20 w-16 absolute md:left-3 md:top-3 z-10"
                        >
                            <path
                                fill="#ffffff"
                    ...
                    <nav
                        id="hamburger"
                        className="h-full w-64 text-white flex justify-center flex-col gap-8 ps-4 absolute -left-96 transition-all ease-out duration-200"
